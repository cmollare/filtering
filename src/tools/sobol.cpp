...
//    The routine adapts the ideas of Antonov and Saleev.
//
//    This routine uses LONG INT for integers and DOUBLE for real values.
//
//  Modified:
//
//    08 January 2007
...
//
  ...
  long int k;
  long int l;
  static long int lastq[DIM_MAX2];
  long int m;
  static long int maxcol;
  long int newv;
  static long int poly[DIM_MAX2] =
  {
        1,    3,    7,   11,   13,   19,   25,   37,   59,   47,
       61,   55,   41,   67,   97,   91,  109,  103,  115,  131,
      193,  137,  145,  143,  241,  157,  185,  167,  229,  171,
  ...
  long int seed_temp;
  static long int v[DIM_MAX2][LOG_MAX];
...
//  Parameters:
//
//    Input, long int I1, I2, two integers to be compared.
//
//    Output, long int I8_MAX, the larger of I1 and I2.
//
{
  if ( i2 < i1 ) 
  {
...
//    Input, long int I1, I2, two integers to be compared.
//
//    Output, long int I8_MIN, the smaller of I1 and I2.
//
{
  if ( i1 < i2 ) 
  {
...
long int i8_uniform ( long int a, long int b, int *seed )
...
//  Parameters:
//
//    Input, long int A, B, the limits of the interval.
//
//    Input/output, int *SEED, the "seed" value, which should NOT be 0.
//    On output, SEED has been updated.
//
